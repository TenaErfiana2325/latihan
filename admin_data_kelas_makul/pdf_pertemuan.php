...
// Bobot Presensi diambil dari database (tbl_kelasmatkul), default 20 jika kosong
$bobot_presensi = isset($data_kelas['bobot_presensi']) ? $data_kelas['bobot_presensi'] : 20; 
...
// Baris 4 (Tambahan Informasi Bobot Presensi)
$pdf->Cell(35, 6, ' BOBOT PRESENSI', 0, 0, 'L');
$pdf->Cell(5, 6, ':', 0, 0, 'C');
$pdf->Cell(150, 6, $bobot_presensi . '%', 0, 1, 'L');
...
// Query Data Mahasiswa di Kelas Ini (Sesuai kode awal dengan AND)
